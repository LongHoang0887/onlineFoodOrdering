...
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -1844537761452490190L;
  ...
  private java.lang.Boolean hasPurchased;

  /**
   * Gets the field hasPurchased.
   * @return the value of the field hasPurchased; may be null.
   */
  public java.lang.Boolean getHasPurchased()
  {
    return hasPurchased;
  }

  /**
   * Sets the field hasPurchased.
   * @param _hasPurchased the new value of the field hasPurchased.
   */
  public void setHasPurchased(java.lang.Boolean _hasPurchased)
  {
  ...
  private transient java.lang.Integer numberOfOrdered;

  /**
   * Gets the field numberOfOrdered.
   * @return the value of the field numberOfOrdered; may be null.
   */
  public java.lang.Integer getNumberOfOrdered()
  {
    return numberOfOrdered;
  }

  /**
   * Sets the field numberOfOrdered.
   * @param _numberOfOrdered the new value of the field numberOfOrdered.
   */
  public void setNumberOfOrdered(java.lang.Integer _numberOfOrdered)
  {
    numberOfOrdered = _numberOfOrdered;
  }

  private transient java.util.List<online.food.ordering.Food> foods;
