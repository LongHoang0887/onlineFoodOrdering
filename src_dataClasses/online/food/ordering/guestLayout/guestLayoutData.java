package online.food.ordering.guestLayout;

/**
 */
@SuppressWarnings("all")
@javax.annotation.Generated(comments="This is the java file of the ivy data class guestLayoutData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class guestLayoutData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
   ...
   */
  public ch.ivyteam.ivy.scripting.objects.List<online.food.ordering.Restaurant> getRestaurantList()
  {
